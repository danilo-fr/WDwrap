...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $opsfa(ncmax),knobs(ncmax+2),ksd(ncmax),ratlum(ncmax)
...
c    of a given solution.
c
c     if(niter.ne.1.and.niter.ne.niters) goto 818
