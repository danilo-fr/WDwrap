...
c
   66 dint1=pi*(1.d0-ot*xbol1)
      if(ld1.eq.2) DINT1=dint1+PI*2.d0*ybol1/9.d0
      if(ld1.eq.3) dint1=dint1-.2d0*pi*ybol1
      dint2=pi*(1.d0-ot*xbol2)
      if(ld2.eq.2) DINT2=dint2+PI*2.d0*ybol2/9.d0
      if(ld2.eq.3) dint2=dint2-.2d0*pi*ybol2
      NSTOT=NSP1+NSP2                                                     
      NP1=N1+1                                                            
      NP2=N1+N2+2                                                         
      IRTE=0                                                              
