...
c  
  ...
  250 format(4x,I1,3x,f13.4,9x,f9.4,6x,f6.2,8x,f5.2,3x,d14.5,f16.5)                      
...
c     =============================================================================
      open(2, FILE='hjd.dat', STATUS='OLD')
      nro=0
      i=1
      ndata=1
      do while (nro.eq.0)
...
c      do 20 iphjd=1,kstop
c      phjd=start+step*dfloat(iphjd-1)
c      hjdi=phjd                                                           
c      phasi=phjd                                                          
      do 20 j=1,ndata,1                              
      hjdi=tempo(j)                                                           
